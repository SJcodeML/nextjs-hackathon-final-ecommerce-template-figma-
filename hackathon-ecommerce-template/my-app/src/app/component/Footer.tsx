...
export default function Footer (){
    return (
        <div className="h-96 bg-[#EEEFFB] flex justify-around ">
            <div>
...
//     <p className="text-[1.5rem] font-semibold hover:underline cursor-pointer">Categories</p>  
//     <ul className="text-[#8A8FB9] font-normal text-sm leading-[1.75rem] pt-4">  
//       <li className="hover:underline cursor-pointer">Laptops & Computers</li>  
//       <li className="hover:underline cursor-pointer">Cameras & Photography</li>  
//       <li className="hover:underline cursor-pointer">Smart Phones & Tablets</li>  
//       <li className="hover:underline cursor-pointer">Video Games Consoles</li>  
//       <li className="hover:underline cursor-pointer">Waterproof Headphones</li>  
//     </ul>  
//   </div>  

//   <div className="w-full md:w-1/4 pt-6 md:pt-10 mb-6 md:mb-0">  
//     <p className="text-[1.5rem] font-semibold hover:underline cursor-pointer">Customer Care</p>  
//     <ul className="text-[#8A8FB9] font-normal text-sm leading-[1.75rem] pt-4">  
...
//     <p className="text-[1.5rem] font-semibold hover:underline cursor-pointer">Pages</p>  
//     <ul className="text-[#8A8FB9] font-normal text-sm leading-[1.75rem] pt-4">  
//       <li className="hover:underline cursor-pointer">Blog</li>  
//       <li className="hover:underline cursor-pointer">Browse the Shop</li>  
//       <li className="hover:underline cursor-pointer">Pre-Built Pages</li>  
//       <li className="hover:underline cursor-pointer">Visual Composer Elements</li>  
//       <li className="hover:underline cursor-pointer">WooCommerce Pages</li>  
//     </ul>  
//   </div>  
// </div>
